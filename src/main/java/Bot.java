...
//        inlineKeyboardButtonAdd.setUrl("https://core.telegram.org/bots/api#answerwebappquery");
    ...
    public void setAnswer() {
        ...
        //String hello = "Новый склад по адресу: Индустриальный промышленный парк Рязанский, Тюшевское сельское поселение, Рязанский район. " +
        String hello = "Добавены новые склады: " +
                "\n" +
                "\n" +
                "Екатеринбург - Испытателей 14г (ул. Испытателей, 14Г)" +
                "\n" +
                "\n" +
                "Подольск (ул. Поливановская, 9с5)"  +
                "\n" +
                "\n" +
                "Санкт-Петербург (Всеволожский р-н, г.п. Свердловское, дер. Новосаратовка, участок № 1 (промзона Уткина Заводь, комплекс МЛП, корпус 4, парадная 4))" +
                "\n" +
                "\n" +
                "В список отслеживания новые склады можно добавить через кнопку \"Меню\"";
        for (Person p: personArrayList) {
